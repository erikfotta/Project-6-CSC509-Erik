...
//  To Do App v1
//
//  Created by Erik Fotta on 1/29/20.
...
class EditItemViewController: UIViewController {
    ...
    // Edits each agenda item
    func editItem(_ jobIndex: [Int]) {
//        if jobIndex == [] {
...
//
        var arraySlot =  find(self.indexL, )
        // Append inputs to the saved arrays
        self.titlesData[ = titleTextEntry.text!
    ...
    @IBAction func finishEditNewItem(_ sender: Any) {
        editItem(indexData)
